...
cp -a --preserve=all "$SRC_DIR/platform/exynos982x/mods/oneui7/smali/system/priv-app/ClockPackage/ClockPackage.apk" "$APKTOOL_DIR/system/priv-app/ClockPackage/"
