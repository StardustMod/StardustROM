# Remove *.prof Files
DELETE_FROM_WORK_DIR "system" "system/app/ClockPackage/ClockPackage.apk.prof"
...
cp -a --preserve=all "$SRC_DIR/platform/exynos982x/mods/oneui7/smali/system/priv-app/ClockPackage/ClockPackage.apk/"* "$APKTOOL_DIR/system/priv-app/ClockPackage/ClockPackage.apk"
DECODE_APK "system" "system/priv-app/SamsungCamera/SamsungCamera.apk"
cp -a --preserve=all "$SRC_DIR/platform/exynos982x/mods/oneui7/smali/system/priv-app/SamsungCamera/SamsungCamera.apk/"* "$APKTOOL_DIR/system/priv-app/SamsungCamera/SamsungCamera.apk"
DECODE_APK "system" "system/priv-app/SecSettings/SecSettings.apk"
cp -a --preserve=all "$SRC_DIR/platform/exynos982x/mods/oneui7/smali/system/priv-app/SecSettings/SecSettings.apk/"* "$APKTOOL_DIR/system/priv-app/SecSettings/SecSettings.apk"
